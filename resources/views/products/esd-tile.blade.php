...
<section id="topRow">
  ...
  <div class="referenceImage">
    <img src="{{ asset('images/products/tiles/tilesrefimg.png') }}" alt="Reference Room">
  </div>

  <!-- Right: 2 vertical swatches -->
  <div class="verticalSwatches">
    <div class="swatchCard">
      <img src="{{ asset('images/products/tiles/HP-ESD-506.png') }}" alt="HP-ESD-506">
      <p>HP-ESD-506</p>
    </div>
    <div class="swatchCard">
      <img src="{{ asset('images/products/tiles/HP-ESD-512.png') }}" alt="HP-ESD-512">
      <p>HP-ESD-512</p>
    </div>
