...
<script>
  ...
  <title>Homogeneous Vinyl Flooring in Kathmandu | Reliable Flooring</title>
...
<section id="advantages" style="width: 100vw; padding: 2rem; background: #ffffff; box-sizing: border-box;">
  <!-- Header Section -->
  ...
  <div class="advantages-cards">
    ...
    <div class="advantage-card">
      <i class="fas fa-tools" style="color: #2980b9;"></i>
      <p>Easy Maintenance</p>
    </div>
    <div class="advantage-card">
      <i class="fas fa-shield-alt" style="color: #c0392b;"></i>
      <p>Super Wear-Resistant</p>
    </div>
    <div class="advantage-card">
      <i class="fas fa-shoe-prints" style="color: #8e44ad;"></i>
      <p>Anti Slip</p>
    </div>
    <div class="advantage-card">
      <i class="fas fa-volume-up" style="color: #d35400;"></i>
      <p>Sound Absorbing</p>
    </div>
    <div class="advantage-card">
      <i class="fas fa-bug-slash" style="color: #16a085;"></i>
      <p>Anti Bacterial</p>
    </div>
  </div>
</section>
...
<section id="applications" style="width: 100vw; padding: 2rem; background: #ffffff; box-sizing: border-box;">
  <!-- Header -->
  ...
  <div class="application-cards">
    ...
    <div class="application-card">
      <i class="fas fa-graduation-cap" style="color: #2980b9;"></i>
      <p>Education</p>
    </div>
    <div class="application-card">
      <i class="fas fa-briefcase" style="color: #c0392b;"></i>
      <p>Office</p>
    </div>
    <div class="application-card">
      <i class="fas fa-shopping-cart" style="color: #8e44ad;"></i>
      <p>Shopping Mall</p>
    </div>
    <div class="application-card">
      <i class="fas fa-bus" style="color: #d35400;"></i>
      <p>Transportation</p>
    </div>
    <div class="application-card">
      <i class="fas fa-industry" style="color: #16a085;"></i>
      <p>Factories</p>
    </div>
  </div>
</section>
